...
export default function Home(){
    return(
        <div className="container mx-auto px-4 flex flex-col lg:flex-row">
            ...
            <div className="relative mt-20 lg:flex-1 flex flex-col md:flex-col space-y-5 justify-center items-center">
                <div className="h-80 w-80 space-y-4">

                    <img src={pic1} className="lg:absolute relative mx-auto rounded-xl md:animate-bounce delay-300 lg:top-0 lg:left-20 h-[125px] w-[200px]"/>
                    <img src={pic2} className="lg:absolute relative mx-auto rounded-xl md:animate-bounce delay-500 lg:top-36 lg:right-4 h-[150px] w-[300px]"/>
                    <img src={pic3} className="lg:absolute relative mx-auto rounded-xl md:animate-bounce delay-700 lg:bottom-2 lg:left-4 h-[125px] w-[200px]"/>
                    <img src={pic4} className="lg:absolute relative mx-auto rounded-xl md:animate-bounce delay-1000 50 lg:-bottom-36 lg:right-36 h-[125px] w-[250px]"/>
